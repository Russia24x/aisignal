...
- **تیکر قیمت**: حالت واحد REST (poll ۶۰s + کش سرور) — ✅ حذف کامل سوکت برای انطباق با لایهٔ رایگان
...
7. ~~ws-ticker برای محیط production باید بازطراحی شود~~ — **حل شد**: سرویس سوکت به‌طور کامل حذف شد و تیکر با REST واحد کار می‌کند (سازگار با Cloudflare رایگان)
