...
| محصول | قیمت | دسترسی |
|---|---|---|
| دسترسی پلتفرم | **۵ PENGU** | یک‌باره — ورود دائمی به داشبورد |
| سیگنال یک‌روزه | **۱ PENGU** | سیگنال امروز تا پایان روز UTC |
| اشتراک ۷ روزه | **۷ PENGU** | هر روز ۱ پنگو |
| اشتراک ۳۰ روزه | **۳۰ PENGU** | هر روز ۱ پنگو — بهترین ارزش |

همه پرداخت‌ها به آدرس خزانه (قابل تغییر در `.env`) منتقل و روی زنجیره تأیید می‌شوند.
